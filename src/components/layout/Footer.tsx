...
<footer className="w-full bg-footer text-light">
  <div className="container mx-auto p-3">
    <div className="flex justify-between my-4 flex-wrap">
      <div className="flex flex-col w-full sm:w-[45%] md:w-[23%] gap-2">
        <p>dasdadada</p>
        <div className="flex items-center space-x-4">
          <a href="#" className="rounded-full border w-8 h-8 flex items-center justify-center">
      ...
      <div className="flex flex-col w-full sm:w-[45%] md:w-[23%] gap-1">
        <Link className="footer-link" to="/legal/terms&condition"> Terms & Conditions </Link>
        <Link className="footer-link" to="/legal/privacy-policy"> Privacy Policy </Link>
        <Link className="footer-link" to="/ase"> Accessibility </Link>
      </div>
    </div>
  </div>
